...
export const metadata = {
  title: "Blog — Dr. Anju's Homeo Clinic",
  description:
    "Expert insights on natural healing, chronic conditions, and the science behind homeopathy.",
};
      ...
      <section className="bg-[#faf9f6] py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-[#2b2b2b] mb-5 font-[family-name:var(--font-playfair)]">
              Learn &amp; Heal
            </h1>
              ...
              {posts.map((post) => (
                ...
                >
                  ...
                  <div className="px-7 py-6 flex flex-col flex-1 gap-4">
                    ...
                    <h2 className="text-xl font-bold text-[#2b2b2b] leading-snug font-[family-name:var(--font-playfair)]">
                      {post.title}
                    </h2>
